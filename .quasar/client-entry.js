...
import qboot_BootConstantes from 'boot/Constantes'
...
async function start () {
  ...
  const bootFiles = [qboot_Bootcompositionapi,qboot_Bootaxios,qboot_BootConstantes,qboot_Bootwebsocketclient]
